...
const SketchnoteLogin = () => {
  ...
  const floatingIcons = [
    { Icon: Brush, position: 'top-16 left-16', delay: 0, duration: 4, color: 'text-pink-300' },
    { Icon: Palette, position: 'top-24 right-20', delay: 0.5, duration: 5, color: 'text-purple-300' },
    { Icon: Pencil, position: 'top-40 left-32', delay: 1, duration: 4.5, color: 'text-yellow-300' },
    { Icon: PenTool, position: 'top-1/4 right-28', delay: 1.5, duration: 5.5, color: 'text-blue-300' },
    { Icon: Eraser, position: 'bottom-32 left-24', delay: 2, duration: 4.8, color: 'text-red-300' },
    { Icon: Shapes, position: 'bottom-40 right-32', delay: 0.8, duration: 5.2, color: 'text-green-300' },
    { Icon: Type, position: 'top-1/3 left-20', delay: 1.2, duration: 4.3, color: 'text-cyan-300' },
    { Icon: Layers, position: 'bottom-1/4 right-24', delay: 1.8, duration: 5.8, color: 'text-indigo-300' },
    { Icon: Image, position: 'top-1/2 right-16', delay: 0.3, duration: 4.6, color: 'text-orange-300' },
    { Icon: Sparkles, position: 'top-2/3 left-28', delay: 2.2, duration: 5.3, color: 'text-yellow-200' },
    { Icon: Scissors, position: 'bottom-1/3 left-36', delay: 1.6, duration: 4.9, color: 'text-teal-300' },
    { Icon: Users, position: 'top-1/2 left-12', delay: 0.6, duration: 5.6, color: 'text-purple-200' },
    { Icon: Circle, position: 'bottom-20 right-40', delay: 1.3, duration: 4.4, color: 'text-pink-200' },
    { Icon: Square, position: 'top-20 right-1/3', delay: 0.9, duration: 5.1, color: 'text-blue-200' },
    { Icon: Triangle, position: 'bottom-1/2 right-20', delay: 1.9, duration: 4.7, color: 'text-green-200' },
    { Icon: Star, position: 'top-3/4 right-1/4', delay: 0.4, duration: 5.4, color: 'text-yellow-300' },
    { Icon: Heart, position: 'bottom-1/4 left-1/4', delay: 1.4, duration: 5.9, color: 'text-red-200' },
    { Icon: Smile, position: 'top-1/3 right-1/3', delay: 2.1, duration: 4.2, color: 'text-orange-200' },
  ];
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden bg-gradient-to-br from-[#1e3a8a] via-[#3b82f6] to-[#06b6d4]">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 via-transparent to-cyan-500/20" style={{ zIndex: 2 }} />

      {/* Floating drawing tool icons - scattered everywhere */}
      {floatingIcons.map(({ Icon, position, delay, duration, color }, index) => (
        <motion.div
          key={index}
          ...
          transition={{ 
            ...
            scale: { repeat: Infinity, duration: duration, ease: "easeInOut" },
            delay: delay
          }}
          style={{ zIndex: 3 }}
        >
