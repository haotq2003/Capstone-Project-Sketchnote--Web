    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={styles.animation}>
          <Lottie animationData={alertAnimation} loop={true} autoplay={true} />
        </div>
        {/* Title */}
        ...
        <p style={styles.description}>
          ...
          <br />
          This verification link may be expired, invalid, or already used.
        </p>

        {/* Hint */}
        <div style={styles.hint}>
          Please return to the <b>SketchNotes app</b> and request a new
          verification email.
        </div>
...
const styles = {
  page: {
    minHeight: "100vh",
    background: "linear-gradient(135deg, #fbe9e7, #fff5f3)",
    display: "flex",
    alignItems: "center",
